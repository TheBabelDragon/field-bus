...
/**
 * Field Bus — pack / unpack helpers
 *
 * Keep all CAN bit-twiddling here so application code stays clean.
 */
...
/** Fill a header. Returns total bytes written (always sizeof(FieldBusHeader)). */
...
/** Unpack header. Returns false if version mismatch or buffer too short. */
...
/** Pack NODE_HELLO payload after the header. */
